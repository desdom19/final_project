...
public static class SeedData
{
    public static void Initialize(IServiceProvider serviceProvider)
    {
        ...
        {
            new Meal { MealName = "Scrambled Eggs with Avocado", TimeCategory = "Breakfast", PreparationTime = 10, TotalCalories = 380.00m, TotalCost = 1.20m },
            new Meal { MealName = "Oatmeal with Berries and Honey", TimeCategory = "Breakfast", PreparationTime = 5, TotalCalories = 400.00m, TotalCost = 1.15m },
            new Meal { MealName = "Greek Yogurt Parfait", TimeCategory = "Breakfast", PreparationTime = 5, TotalCalories = 305.00m, TotalCost = 2.05m },
            new Meal { MealName = "Peanut Butter Banana Toast", TimeCategory = "Breakfast", PreparationTime = 5, TotalCalories = 435.00m, TotalCost = 0.79m },
            new Meal { MealName = "Breakfast Burrito with Salsa", TimeCategory = "Breakfast", PreparationTime = 15, TotalCalories = 370.00m, TotalCost = 1.15m },
            new Meal { MealName = "Pancakes with Maple Syrup", TimeCategory = "Breakfast", PreparationTime = 20, TotalCalories = 464.00m, TotalCost = 1.30m },
            new Meal { MealName = "Fruit and Spinach Smoothie", TimeCategory = "Breakfast", PreparationTime = 5, TotalCalories = 235.00m, TotalCost = 1.20m },
            new Meal { MealName = "Belgian Waffles with Cream", TimeCategory = "Breakfast", PreparationTime = 25, TotalCalories = 340.00m, TotalCost = 1.25m },
            new Meal { MealName = "Avocado Toast with Poached Egg", TimeCategory = "Breakfast", PreparationTime = 10, TotalCalories = 260.00m, TotalCost = 1.15m },
            new Meal { MealName = "Egg Muffins with Spinach", TimeCategory = "Breakfast", PreparationTime = 30, TotalCalories = 479.00m, TotalCost = 1.68m },
            new Meal { MealName = "Grilled Chicken Caesar Salad", TimeCategory = "Lunch", PreparationTime = 15, TotalCalories = 413.00m, TotalCost = 1.96m },
            new Meal { MealName = "Turkey and Swiss Cheese Wrap", TimeCategory = "Lunch", PreparationTime = 10, TotalCalories = 340.00m, TotalCost = 1.59m },
            new Meal { MealName = "Quinoa and Black Bean Bowl", TimeCategory = "Lunch", PreparationTime = 20, TotalCalories = 295.00m, TotalCost = 1.60m },
            new Meal { MealName = "Tomato Basil Soup", TimeCategory = "Lunch", PreparationTime = 25, TotalCalories = 122.50m, TotalCost = 1.00m },
            new Meal { MealName = "Tuna Salad Sandwich", TimeCategory = "Lunch", PreparationTime = 10, TotalCalories = 370.00m, TotalCost = 1.95m },
            new Meal { MealName = "Caprese Salad with Balsamic", TimeCategory = "Lunch", PreparationTime = 10, TotalCalories = 382.50m, TotalCost = 2.45m },
            new Meal { MealName = "Chicken Noodle Soup", TimeCategory = "Lunch", PreparationTime = 35, TotalCalories = 495.00m, TotalCost = 2.10m },
            new Meal { MealName = "Hummus and Veggie Pita", TimeCategory = "Lunch", PreparationTime = 10, TotalCalories = 308.00m, TotalCost = 1.52m },
            new Meal { MealName = "BBQ Pulled Pork Slider", TimeCategory = "Lunch", PreparationTime = 15, TotalCalories = 206.00m, TotalCost = 0.81m },
            new Meal { MealName = "Cobb Salad with Ranch", TimeCategory = "Lunch", PreparationTime = 15, TotalCalories = 483.00m, TotalCost = 2.21m },
            new Meal { MealName = "Spaghetti Bolognese", TimeCategory = "Dinner", PreparationTime = 40, TotalCalories = 620.00m, TotalCost = 3.20m },
            new Meal { MealName = "Baked Salmon with Asparagus", TimeCategory = "Dinner", PreparationTime = 25, TotalCalories = 365.00m, TotalCost = 4.25m },
            new Meal { MealName = "Beef Stir-Fry with Broccoli", TimeCategory = "Dinner", PreparationTime = 20, TotalCalories = 415.00m, TotalCost = 2.68m },
            new Meal { MealName = "Chicken Parmesan with Pasta", TimeCategory = "Dinner", PreparationTime = 45, TotalCalories = 620.00m, TotalCost = 2.93m },
            new Meal { MealName = "Tacos with Ground Beef", TimeCategory = "Dinner", PreparationTime = 20, TotalCalories = 740.00m, TotalCost = 2.78m },
            new Meal { MealName = "Margherita Pizza", TimeCategory = "Dinner", PreparationTime = 35, TotalCalories = 506.00m, TotalCost = 3.08m },
            new Meal { MealName = "Pork Chops with Applesauce", TimeCategory = "Dinner", PreparationTime = 30, TotalCalories = 330.00m, TotalCost = 2.35m },
            new Meal { MealName = "Lentil Curry with Rice", TimeCategory = "Dinner", PreparationTime = 40, TotalCalories = 422.50m, TotalCost = 1.23m },
            new Meal { MealName = "Shrimp Scampi over Linguine", TimeCategory = "Dinner", PreparationTime = 20, TotalCalories = 380.00m, TotalCost = 3.43m },
            new Meal { MealName = "Grilled Steak with Garlic Butter", TimeCategory = "Dinner", PreparationTime = 20, TotalCalories = 385.00m, TotalCost = 4.83m }
